...
import android.support.v7.recyclerview.C0164R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C01963();
    ...
    static class C01963 implements Interpolator {
        C01963() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0164R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0164R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0164R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0164R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0164R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C03344 implements ProcessCallback {
        C03344() {
        }
    ...
    class C03355 implements Callback {
        C03355() {
        }
    ...
    class C03366 implements Callback {
        C03366() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03371());
        Parcelable mLayoutState;

        static class C03371 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03371() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01941();
        ...
        this.mItemAnimatorRunner = new C01952();
        this.mViewInfoProcessCallback = new C03344();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0164R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0164R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0164R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03355());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03366());
    }
