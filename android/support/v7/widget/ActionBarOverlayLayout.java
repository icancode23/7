...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0163R.attr.actionBarSize, 16842841};
    ...
    class C01753 implements Runnable {
        C01753() {
        }
    ...
    class C03641 extends ViewPropertyAnimatorListenerAdapter {
        C03641() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03641();
        this.mRemoveActionBarHideOffset = new C01742();
        this.mAddActionBarHideOffset = new C01753();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0163R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0163R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0163R.id.action_bar));
        }
    }
