...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01871 implements OnAttachStateChangeListener {
        C01871() {
        }
    ...
    class C01882 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01871());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01882());
    }
