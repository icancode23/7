...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03611();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03622();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03183();

    class C03183 implements ViewPropertyAnimatorUpdateListener {
        C03183() {
        }
    ...
    class C03611 extends ViewPropertyAnimatorListenerAdapter {
        C03611() {
        }
    ...
    class C03622 extends ViewPropertyAnimatorListenerAdapter {
        C03622() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0163R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0163R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0163R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0163R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0163R.styleable.ActionBar, C0163R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0163R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0163R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0163R.attr.actionBarWidgetTheme, outValue, true);
