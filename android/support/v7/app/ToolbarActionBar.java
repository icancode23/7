...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C03172();
    private final Runnable mMenuInvalidator = new C01621();
    ...
    class C03172 implements OnMenuItemClickListener {
        C03172() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0163R.layout.abc_list_menu_item_layout);
