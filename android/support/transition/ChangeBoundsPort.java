...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00273 extends AnimatorListenerAdapter {
        C00273() {
        }
    ...
    class C03521 extends TransitionListenerAdapter {
    ...
    class C03532 extends TransitionListenerAdapter {
        boolean mCanceled = false;
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C03532());
                    }
                    anim.addListener(new C00273());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
