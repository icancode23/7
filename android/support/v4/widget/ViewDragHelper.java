...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01461();
    ...
    private final Runnable mSetIdleRunnable = new C01472();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01461 implements Interpolator {
        C01461() {
        }
