...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00592();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00581();
    ...
    class C00592 implements OnItemClickListener {
        C00592() {
        }
