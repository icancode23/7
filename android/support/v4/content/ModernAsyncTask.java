...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00611();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02792();

    static class C00611 implements ThreadFactory {
    ...
    class C02792 extends WorkerRunnable<Params, Result> {
        C02792() {
        }
