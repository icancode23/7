...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C00981();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C00981 implements Creator<QueueItem> {
            C00981() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C00991();
        private ResultReceiver mResultReceiver;

        static class C00991 implements Creator<ResultReceiverWrapper> {
            C00991() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01001();
        private final Object mInner;

        static class C01001 implements Creator<Token> {
            C01001() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02891();
        ...
        class C02891 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02891() {
            }
        ...
        class C03572 implements Callback {
            C03572() {
            }
