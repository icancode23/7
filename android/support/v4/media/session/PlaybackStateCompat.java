...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01021();
    ...
    static class C01021 implements Creator<PlaybackStateCompat> {
        C01021() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01031();
        ...
        static class C01031 implements Creator<CustomAction> {
            C01031() {
            }
