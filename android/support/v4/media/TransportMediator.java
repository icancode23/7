...
public class TransportMediator extends TransportController {
    ...
    class C00872 implements Callback {
        C00872() {
        }
    ...
    class C02861 implements TransportMediatorCallback {
        C02861() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C02861();
        this.mKeyEventCallback = new C00872();
