...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00914();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00925();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00903();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00936();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00881();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00892();

    class C00881 implements OnWindowAttachListener {
        C00881() {
        }
    ...
    class C00892 implements OnWindowFocusChangeListener {
        C00892() {
        }
    ...
    class C00903 extends BroadcastReceiver {
        C00903() {
        }
    ...
    class C00914 implements OnAudioFocusChangeListener {
        C00914() {
        }
    ...
    class C00925 implements OnGetPlaybackPositionListener {
        C00925() {
        }
    ...
    class C00936 implements OnPlaybackPositionUpdateListener {
        C00936() {
        }
