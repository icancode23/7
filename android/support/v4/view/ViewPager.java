...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01201();
    ...
    private static final Interpolator sInterpolator = new C01212();
    ...
    private final Runnable mEndScrollRunnable = new C01223();
    ...
    static class C01201 implements Comparator<ItemInfo> {
        C01201() {
        }
    ...
    static class C01212 implements Interpolator {
        C01212() {
        }
    ...
    class C01223 implements Runnable {
        C01223() {
        }
    ...
    class C03004 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03011());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03011 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03011() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03004());
    }
