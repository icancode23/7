...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C02391());

    static class C02391 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C02391() {
        }
