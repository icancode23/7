...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C02522 extends AccessibilityDelegateCompat {
        C02522() {
        }
    ...
    class C02533 extends BottomSheetCallback {
        C02533() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C02533();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(), C0003R.layout.design_bottom_sheet_dialog, null);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0003R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0003R.id.touch_outside).setOnClickListener(new C00111());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C02522());
        return coordinator;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0003R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0003R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
