...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C02453();
    private final ViewGroup mTargetParent;
    final SnackbarBaseLayout mView;

    static class C00071 implements Callback {
        C00071() {
        }
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            if (a.hasValue(C0003R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0003R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    class C02442 implements OnApplyWindowInsetsListener {
        C02442() {
        }
    ...
    class C02453 implements Callback {
        C02453() {
        }
    ...
    class C02464 implements OnDismissListener {
        C02464() {
        }
    ...
    class C02475 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C00081());
            }
        }
    }

    class C02486 implements OnLayoutChangeListener {
        C02486() {
        }
    ...
    class C03467 extends ViewPropertyAnimatorListenerAdapter {
        C03467() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C02442());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C02464());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C02475());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C02486());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C03467()).start();
            return;
        }
