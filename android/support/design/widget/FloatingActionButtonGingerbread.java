...
class FloatingActionButtonGingerbread extends FloatingActionButtonImpl {
    ...
    void hide(@Nullable final InternalVisibilityChangedListener listener, final boolean fromUser) {
        if (!isOrWillBeHidden()) {
            this.mAnimState = 1;
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0003R.anim.design_fab_out);
    ...
    void show(@Nullable final InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0003R.anim.design_fab_in);
            anim.setDuration(200);
