...
public class UpdatePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0218R.layout.activity_update_password);
        final EditText etus = (EditText) findViewById(C0218R.id.etusername);
        final EditText etpa = (EditText) findViewById(C0218R.id.etpassword);
        final EditText etnewpass = (EditText) findViewById(C0218R.id.etnewpass);
        this.bpass = (Button) findViewById(C0218R.id.bpass);
        this.tvloading = (TextView) findViewById(C0218R.id.tvloading);
        this.mProgressBar = (ProgressBar) findViewById(C0218R.id.progressBar2);
